...
class _LoginPageState extends State<LoginPage> {
  ...
  Future<bool> _verifyUser(String username, String password) async {
    ...
    return username.trim().isNotEmpty && password.trim().length >= 4;
  }
  ...
  Future<void> _handleLogin() async {
    ...
    final isValid = await _verifyUser(
  ...
  Widget sectionTitle(double fontSize) {
    return Text(
      'Login',
  ...
  Widget usernameTextField(Size size) {
    final hasText = usernameController.text.isNotEmpty;
  ...
  Widget passwordTextField(Size size) {
    final hasText = passController.text.isNotEmpty;
    ...
    return Padding(
      ...
      child: Row(
        children: [
          ...
          Text(
            'Remember me',
            style: GoogleFonts.inter(fontSize: 14.0, color: const Color(0xFF0C0D34)),
          ),
          const Spacer(),
          Text(
            'Forgot password?',
      ...
      child: Text.rich(
        TextSpan(
          ...
          children: const [
            ...
            TextSpan(
              text: 'Sign Up here',
              style: TextStyle(color: Color(0xFFFF7248), fontWeight: FontWeight.w500),
            ),
          ],
        ),
        textAlign: TextAlign.center,
