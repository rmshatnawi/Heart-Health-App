    ...
    return const SimpleInfoPage(
      ...
      sections: [
        ...
        InfoSection(
          ...
          subtitle: 'Simple ways to help your child drink enough fluids.',
        ...
        InfoSection(
          ...
          items: [
            ...
            InfoItem(
              ...
              description: 'Decreased urination or dark-colored urine.',
            ),
            InfoItem(
              icon: Icons.child_care_outlined, // FIXED (was Icons.crying_baby_outlined)
              iconColor: Color(0xFF8A1D3D),
              title: 'No tears',
            ...
            InfoItem(
              ...
              description: 'Rapid breathing or increased heart rate.',
            ),
            InfoItem(
